  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* FAQ SEO LOCAL */}
        <section className="py-16 md:py-20 bg-slate-50" aria-labelledby="preguntas-frecuentes">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              <p className="text-orange-600 font-semibold uppercase tracking-wide text-sm mb-2">Preguntas frecuentes sobre DTF</p>
              <h2 id="preguntas-frecuentes" className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Todo lo que necesitas saber antes de estampar</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Resolvemos las dudas más comunes sobre precios, telas, duración, archivos y tiempos de entrega de una impresión DTF en Quilpué.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-5">
              {[
                { q: '¿Cuánto cuesta estampar una polera en Quilpué?', a: 'El valor depende de la prenda, el tamaño del diseño y la cantidad de unidades. Puedes solicitar una cotización personalizada por WhatsApp, incluso desde una unidad.' },
                { q: '¿Puedo pedir una sola polera personalizada?', a: 'Sí. Realizamos pedidos desde una unidad y también trabajamos pedidos por mayor para marcas, empresas, gimnasios, colegios y eventos.' },
                { q: '¿Cuánto dura un estampado DTF?', a: 'Un DTF correctamente aplicado puede mantener sus colores y adherencia durante muchos lavados si se siguen las instrucciones de cuidado de la prenda.' },
                { q: '¿Sobre qué telas se puede aplicar DTF?', a: 'El DTF textil funciona sobre algodón, poliéster, mezclas y otras telas compatibles. Antes de producir revisamos el tipo de prenda y el diseño.' },
                { q: '¿Cuánto demora un pedido de estampado?', a: 'La producción habitual tarda entre 1 y 2 días hábiles. El despacho depende de la comuna y del servicio de transporte elegido.' },
                { q: '¿Realizan estampados para empresas y marcas?', a: 'Sí. Ofrecemos descuentos por volumen, ropa corporativa, uniformes, merchandising, colecciones de marcas y gang sheets para talleres.' },
              ].map(({ q, a }) => (
                <details key={q} className="group bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                  <summary className="cursor-pointer list-none pr-8 font-semibold text-gray-900 relative group-open:text-orange-600">
                    {q}
                    <span className="absolute right-0 top-0 text-orange-500 text-xl leading-none" aria-hidden="true">+</span>
                  </summary>
            ...
            <div className="text-center mt-8">
              <Link href="/blog" className="text-orange-600 font-semibold hover:text-orange-700">Lee nuestras guías sobre DTF y poleras personalizadas →</Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="https://wa.link/n54imv" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-500 text-white font-bold px-8 py-4 rounded-xl hover:bg-green-600 transition-all shadow-lg text-lg">
