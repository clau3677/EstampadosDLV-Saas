                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  {selected.deliveryMethod === 'pickup' && selected.status === 'ready_for_pickup' && (
                    <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-3 space-y-2">
                      <div className="flex items-center justify-between gap-2"><div><div className="text-xs font-semibold text-emerald-900">Código de retiro</div><div className="text-[11px] text-emerald-700">Se valida al entregar el pedido en taller.</div></div>{selected.pickupCode ? <span className="text-[11px] font-semibold text-emerald-800">Código generado</span> : <Button size="sm" variant="outline" className="h-8 text-xs" onClick={issuePickupCode} disabled={transitioning}>Generar código</Button>}</div>
