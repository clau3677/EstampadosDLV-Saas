...
export const COLLECTIONS = {
  ...
  FULFILLMENTS: 'fulfillments',                 // despacho/retiro y estado de última milla
  FULFILLMENT_EVENTS: 'fulfillment_events',     // bitácora inmutable de cambios logísticos
  NOTIFICATION_JOBS: 'notification_jobs',       // cola email/WhatsApp con reintentos

  // ---- Módulo Marketing + reputación (auditoría jul-2026) ----
  MARKETING_ACCOUNTS: 'marketing_accounts',   // conexión OAuth Meta (page + IG + ad account) — tokens cifrados AES-256-GCM
  MARKETING_POSTS: 'marketing_posts',         // posts generados con IA: draft → scheduled → published/failed
  MARKETING_CAMPAIGNS: 'marketing_campaigns', // campañas Meta Ads creadas desde el panel (recetas)
  MARKETING_METRICS: 'marketing_metrics',     // snapshots de insights (alcance, clics, gasto)
  REVIEW_REQUESTS: 'review_requests',         // cola de solicitudes de reseña post-venta (WhatsApp/email)
  CONTESTS: 'contests',                        // concursos/giveaways automáticos
  CONTEST_PARTICIPANTS: 'contest_participants', // participantes de concursos

  // ---- Módulo Prospección B2B Quinta Región (build91) ----
  PRO_CAMPAIGNS: 'campaigns',            // campañas de prospección
  PRO_LEADS: 'leads',                    // prospectos descubiertos
  PRO_LEAD_SOURCES: 'lead_sources',      // fuentes de descubrimiento
  PRO_CAMPAIGN_LEADS: 'campaign_leads',  // asignación lead↔campaña
  PRO_CONTACTS: 'contacts',              // contactos por empresa (persona)
  PRO_TEMPLATES: 'message_templates',    // plantillas de mensaje por rubro
  PRO_MESSAGES: 'messages',              // mensajes enviados / simulados
  PRO_SUPPRESSIONS: 'suppressions',      // lista de supresión global
  PRO_JOBS: 'jobs',                      // cola de trabajos (envíos, descubrimiento)
  PRO_AUDIT: 'audit_events',             // log de auditoría inmutable
  PRO_ENRICHMENT: 'enrichment_tasks',    // tareas de enriquecimiento
  PRO_PLACES_CACHE: 'places_cache',        // caché de resultados de Google Places (TTL 7 días)
};
...
export const ORDER_STATUS = {
  PENDING: 'pending',
  AWAITING_PAYMENT: 'awaiting_payment', // Cliente subió comprobante de transferencia, esperando confirmación admin
  PAID: 'paid',
...
export const PRODUCT_CATEGORY = {
  DTF_METER:       'dtf_meter',        // 🎨 DTF por metro (Textil + UV)
  BLANK_APPAREL:   'blank_apparel',    // 👕 Ropa lisa para estampar
  PRINTED_APPAREL: 'printed_apparel',  // ✨ Ropa ya estampada
  CAPS_HATS:       'caps_hats',        // 🧢 Gorras estampadas
  MERCH:           'merch',            // 🎁 Merchandising / accesorios sólidos
  WORKWEAR:        'workwear',         // 🦺 Ropa de trabajo
  // legacy — mantener por compatibilidad histórica, ya no se usan en creación
  APPAREL:   'apparel',
  ACCESSORY: 'accessory',
  OTHER:     'other',
};

// Subcategorías reales soportadas por cada categoría principal.
// Se usa en /tienda para filtros contextuales y en /proveedores para clasificación.
export const SUBCATEGORIES = {
  ...
  workwear: [
    ...
    { code: 'trabajo',   label: 'Ropa de trabajo' },
    { code: 'tecnica',   label: 'Ropa técnica' },
    { code: 'ignifuga',  label: 'Ropa ignífuga' },
    { code: 'outdoor',   label: 'Ropa outdoor' },
  ],
};
 ...
 * @property {string?} fulfillmentId    vínculo al registro logístico
 * @property {string?} fulfillmentStatus estado de última milla
 */
 ...
 * @property {string} description
 * @property {string} prize            ej: "1 Polera personalizada con tu diseño"
 * @property {string} rules            texto HTML/MD de reglas
 * @property {'active'|'ended'} status
 * @property {Date} startDate
 * @property {Date} endDate
 * @property {Object?} winner           { name, email, phone, city } | null
 * @property {Date?} winnerPickedAt
 * @property {Date} createdAt
 */
 ...
 * @property {string} designIdea       idea de diseño para la polera
 * @property {Date} createdAt
 */
