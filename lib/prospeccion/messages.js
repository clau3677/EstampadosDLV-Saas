  ...
  for (const row of rows) {
    try {
      ...
      for (const channel of channels) {
        ...
        const selectedTemplateId = channel === 'whatsapp' ? campaign.whatsappTemplateId : campaign.emailTemplateId;
        const rendered = renderTemplate(channel, lead.category || 'otros', lead, { templateId: selectedTemplateId });
        const msg = {
          id: uuidv4(),
          campaignId,
