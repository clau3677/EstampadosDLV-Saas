...
export const SERVICE_BY_CATEGORY = {
  restaurantes: 'uniformes, ropa de trabajo y poleras con tu marca para tu equipo, resistentes al lavado industrial',
...
const EMAIL_BY_TPL = {
  general: (v) => emailHtml({
    ...
    items: ['Poleras, polerones, gorras y buzos personalizados.',
      'Ropa de trabajo, delantales y uniformes con tu logo.',
...
const WA_BY_TPL = {
  general: (v) => [
    ...
    '',
    `Ayudamos a negocios como *${v.business_name}* con impresión DTF textil y DTF UV: poleras, polerones, gorras, uniformes, ropa de trabajo, delantales, pliegos DTF, vasos, botellas, llaveros y merchandising personalizado.`,
    '',
