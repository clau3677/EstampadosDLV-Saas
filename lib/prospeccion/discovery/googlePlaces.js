        ...
        try {
          ...
          if (cached?.places) {
            ...
            const body = {
              ...
              regionCode: 'CL',
              maxResultCount: 20,
              fields: 'places.displayName,places.formattedAddress,places.primaryType,places.types,places.websiteUri,places.nationalPhoneNumber,places.rating,places.userRatingCount,places.googleMapsUri,places.location',
            };
