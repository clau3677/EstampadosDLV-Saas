...
export async function runDiscovery({ campaignId, categories = null, communes = null, limit = 500, actorId = null } = {}) {
  ...
  // build123: modo masivo — la API pide hasta 20.000 (cobertura total de
  // las 22 comunas en todas las categorías, no solo una muestra).
  const cap = Math.min(Number(limit) || 20000, 20000);
