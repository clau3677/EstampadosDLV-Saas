...
export async function syncInventoryForVariants(db, product, sourceVariants = [], supplierName = 'unknown') {
  ...
  for (const v of product.variants) {
    ...
    } else if (v._supplierInStock !== undefined) {
      // Textil Ryu: no entrega variants[] con inStock, pero buildProductDoc almacena
      // _supplierInStock en cada variante (basado en el hasStock global del producto).
      supplierInStock = v._supplierInStock !== false;
    }
