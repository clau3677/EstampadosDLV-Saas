...
export default async function handleSeed(ctx) {
  ...
  const products = [
    { id: uuidv4(), sku: 'POL-CLA-NEG', name: 'Polera Algodón Clásica', slug: 'polera-algodon-clasica',
      category: PRODUCT_CATEGORY.PRINTED_APPAREL, subcategory: 'poleras',
    ...
    { id: uuidv4(), sku: 'HOO-PREM-NEG', name: 'Poleron con Capucha Premium', slug: 'poleron-capucha-premium',
      category: PRODUCT_CATEGORY.PRINTED_APPAREL, subcategory: 'polerones',
  ...
  // TAXONOMIES — nueva estructura de servicio (6 categorías principales)
  const taxonomies = [
    { id: uuidv4(), kind: 'product_category', code: 'dtf_meter',       label: 'DTF por metro',    extras: { icon: 'Sparkles', color: 'fuchsia', sort: 1 }, createdAt: now },
    { id: uuidv4(), kind: 'product_category', code: 'blank_apparel',   label: 'Ropa Lisa',        extras: { icon: 'Shirt',    color: 'slate',   sort: 2 }, createdAt: now },
    { id: uuidv4(), kind: 'product_category', code: 'printed_apparel', label: 'Ropa Estampada',   extras: { icon: 'Palette',  color: 'orange',  sort: 3 }, createdAt: now },
    { id: uuidv4(), kind: 'product_category', code: 'caps_hats',       label: 'Gorras',           extras: { icon: 'CircleUser', color: 'amber', sort: 4 }, createdAt: now },
    { id: uuidv4(), kind: 'product_category', code: 'merch',           label: 'Merchandising',    extras: { icon: 'Gift',     color: 'teal',    sort: 5 }, createdAt: now },
    { id: uuidv4(), kind: 'product_category', code: 'workwear',        label: 'Ropa de Trabajo',  extras: { icon: 'HardHat',  color: 'indigo',  sort: 6 }, createdAt: now },
