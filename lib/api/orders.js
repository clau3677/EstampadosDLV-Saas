...
// Consume la reserva al confirmar el pago. La operación es atómica y reversible
// si una de las líneas no tiene la reserva esperada.
async function consumeReservedStockForOrder(db, orderId, orderNumber) {
  ...
  if (!order || order.stockReservationStatus === 'consumed') return;
