...
Modalidad: cotización personalizada según producto, cantidad y personalización solicitada.
...
3. Una invitación a cotizar, sin mostrar precios ni rangos de precio
4. Un CTA (llamado a la acción) con el link EXACTO del producto: ${productUrl}
   Usa frases como: "Cotiza tu proyecto aquí:", "Conoce el producto y solicita tu cotización:", "Pide la tuya aquí:"
...
function sanitize(gen, product) {
  ...
  // Las publicaciones sociales no muestran precios; el valor se entrega
  // mediante cotización según cantidad, técnica y personalización.
  caption = caption
    .replace(/(?:💰|precio|desde)\s*[:$]?\s*[\d.,]+[^\n]*/gi, '')
    .replace(/\n{3,}/g, '\n\n')
    .trim();
