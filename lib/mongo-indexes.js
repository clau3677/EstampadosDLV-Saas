...
const INDEX_DEFINITIONS = [
  ...
  { col: 'products',         key: { category: 1, subcategory: 1, active: 1, createdAt: -1 } },
  { col: 'products',         key: { supplier: 1, active: 1, createdAt: -1 } },
  ...
  { col: 'commercial_stock', key: { updatedAt: -1 } },
  { col: 'commercial_stock', key: { productId: 1, updatedAt: -1 } },
  ...
  // --- Caché de Google Places (descubrimiento real) ---
  { col: 'places_cache',         key: { query: 1 },             opts: { unique: true } },
  { col: 'places_cache',         key: { expiresAt: 1 } },
];
