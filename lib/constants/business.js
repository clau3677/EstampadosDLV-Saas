...
export const BUSINESS = {
  ...
  // Perfiles públicos (auditoría jul-2026). Los handles/URLs se pueden
  // sobreescribir desde Configuración de empresa (app_settings.company_info);
  // estos son los valores por defecto que usa el footer público y el JSON-LD.
  social: {
    facebook:  'https://www.facebook.com/estampadosdlv',
    instagram: 'https://www.instagram.com/estampadosdlv',
    tiktok:    'https://www.tiktok.com/@estampadosdlv',
  },

  // Enlace directo para dejar reseña en Google (reemplazar por el enlace real
  // del perfil de Google Business una vez verificado: https://g.page/r/XXXX/review)
  reviews: {
    google:   'https://g.page/r/estampadosdlv/review',
    facebook: 'https://www.facebook.com/estampadosdlv/reviews',
  },
};
